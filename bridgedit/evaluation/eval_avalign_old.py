...
def Cal_Avalign_old(generated_video, generated_audio):
    import os
    files = [file for file in os.listdir(generated_video) if file.endswith('.mp4')]
    score = 0
    from tqdm import tqdm
    for file in tqdm(files, desc="Process Videos"):
        
        file = file[:-4]
        video_path = f'{generated_video}/{file}.mp4'
        audio_path = f'{generated_audio}/{file}.mp4'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", type=str, default='/mnt/task_runtime/dataset/avsync15/test/')
