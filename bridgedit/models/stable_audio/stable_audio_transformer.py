...
class StableAudioDiTModel(ModelMixin, ConfigMixin, PeftAdapterMixin):
    """
    ...
    def forward_1(
        ...
        return hidden_states, attention_mask, cross_attention_hidden_states, time_hidden_states, rotary_embedding
