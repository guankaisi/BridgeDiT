...
from diffusers.pipelines.pipeline_utils import AudioPipelineOutput, DeprecatedPipelineMixin, DiffusionPipeline, StableDiffusionMixin
...
class AudioLDMPipeline(DeprecatedPipelineMixin, DiffusionPipeline, StableDiffusionMixin):
    ...
    def prepare_latents(self, batch_size, num_channels_latents, height, dtype, device, generator, latents=None):
        ...
        print(shape)
        print(height)
        print(self.vae_scale_factor)
        print(self.vocoder.config.model_in_dim)
    ...
    def __call__(
        ...
        print(latents.shape)
        # 5.4s latents shape torch.Size([1, 8, 135, 16])
